...
#            a partir de um arquivo CSV com as colunas Checkin, Repouso, TJS, TJSD, TJSN, TJSE e TJSEN
#            e gerar um relatório em um arquivo texto chamado 'rel_horas_tempo_de_repouso.txt'
...
# Filtrar o DataFrame para excluir as linhas onde a coluna 'Repouso' é nula, vazia ou igual a '-'
dados = dados[(dados['Repouso'].notnull()) & (dados['Repouso'] != '') & (dados['Repouso'] != '-')]

# CONVERTER AS COLUNAS Repouso, TJS, TJSD, TJSN, TJSE e TJSEN PARA timedelta
dados['Repouso'] = pd.to_timedelta(dados['Repouso'])
dados['Tempo Repouso Diurno'] = pd.to_timedelta(dados['Tempo Repouso Diurno'])
dados['Tempo Repouso Noturno'] = pd.to_timedelta(dados['Tempo Repouso Noturno'])
dados['Tempo Repouso Especial Diurno'] = pd.to_timedelta(dados['Tempo Repouso Especial Diurno'])
dados['Tempo Repouso Especial Noturno'] = pd.to_timedelta(dados['Tempo Repouso Especial Noturno'])
...
# Função para limpar e corrigir valores da coluna 'Repouso'
...
def totalizar_por_semana(dados):
    ...
    colunas_tempo = ['Repouso', 'Tempo Repouso Diurno', 'Tempo Repouso Noturno', 'Tempo Repouso Especial Diurno', 'Tempo Repouso Especial Noturno']
...
novo_nome = nome_arquivo.split(")")[0] + ") - REL_HORAS_DE_REPOUSO.txt"
...
with open(novo_nome, 'w') as arquivo:
    ...
    arquivo.write('Activity'.ljust(15) + 'Checkin'.ljust(21) + 'Start'.ljust(14) + 'Dep'.ljust(5) + 'Arr'.ljust(12) + 'End'.ljust(20) + 'Checkout'.ljust(15) + 'Repouso'.ljust(15) + '\n')
    ...
    for linha in range(len(dados)):
        ...
        # Converter 'Repouso' para o formato HH:MM
        repouso_timedelta = dados['Repouso'][linha]
        horas, resto = divmod(repouso_timedelta.total_seconds(), 3600)
        minutos, _ = divmod(resto, 60)
        repouso_formatada = f"{int(horas):02}:{int(minutos):02}"
        ...
        if linha < len(dados) - 1:
            ...
            if pd.to_datetime(dados['Checkin'][linha]).week != pd.to_datetime(dados['Checkin'][linha + 1]).week:
                ...
                total_semana['Repouso                        = '] = total_semana['Repouso'].dt.components.hours + total_semana['Repouso'].dt.components.days * 24
                total_semana['Tempo Repouso Diurno           = '] = total_semana['Tempo Repouso Diurno'].dt.components.hours + total_semana['Tempo Repouso Diurno'].dt.components.days * 24
                total_semana['Tempo Repouso Noturno          = '] = total_semana['Tempo Repouso Noturno'].dt.components.hours + total_semana['Tempo Repouso Noturno'].dt.components.days * 24
                total_semana['Tempo Repouso Especial Diurno  = '] = total_semana['Tempo Repouso Especial Diurno'].dt.components.hours + total_semana['Tempo Repouso Especial Diurno'].dt.components.days * 24
                total_semana['Tempo Repouso Especial Noturno = '] = total_semana['Tempo Repouso Especial Noturno'].dt.components.hours + total_semana['Tempo Repouso Especial Noturno'].dt.components.days * 24
                
                ###

                total_semana['Repouso                        = '] = total_semana['Repouso                        = '].astype(str).str.zfill(2) + ':' + total_semana['Repouso'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Diurno           = '] = total_semana['Tempo Repouso Diurno           = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Noturno          = '] = total_semana['Tempo Repouso Noturno          = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Especial Diurno  = '] = total_semana['Tempo Repouso Especial Diurno  = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Especial Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Especial Noturno = '] = total_semana['Tempo Repouso Especial Noturno = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Especial Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                ...
                if periodo_semanal in total_semana.index:
                    ...
                    valores = total_semana.loc[periodo_semanal, ['Repouso                        = ', 'Tempo Repouso Diurno           = ', 'Tempo Repouso Noturno          = ', 'Tempo Repouso Especial Diurno  = ', 'Tempo Repouso Especial Noturno = ']]
                ...
                arquivo.write(titulo_centralizado + '\n')
                # alinhar a linha abaixo como cabeçalho
                arquivo.write('Activity'.ljust(15) + 'Checkin'.ljust(21) + 'Start'.ljust(14) + 'Dep'.ljust(5) + 'Arr'.ljust(12) + 'End'.ljust(20) + 'Checkout'.ljust(15) + 'Repouso'.ljust(21) + '\n')
            ...
            if semana_atual in total_semana.index: # coloquei agora
                ...
                valores = total_semana.loc[semana_atual, ['Repouso', 'Tempo Repouso Diurno', 'Tempo Repouso Noturno', 'Tempo Repouso Especial Diurno', 'Tempo Repouso Especial Noturno']]
    ...
    for linha in range(len(dados)):
        ...
        if linha < len(dados) - 1:
            if pd.to_datetime(dados['Checkin'][linha]).month != pd.to_datetime(dados['Checkin'][linha + 1]).month:
                ...
                total_mes['Repouso                        = '] = total_mes['Repouso'].dt.components.hours + total_mes['Repouso'].dt.components.days * 24
                total_mes['Tempo Repouso Diurno           = '] = total_mes['Tempo Repouso Diurno'].dt.components.hours + total_mes['Tempo Repouso Diurno'].dt.components.days * 24
                total_mes['Tempo Repouso Noturno          = '] = total_mes['Tempo Repouso Noturno'].dt.components.hours + total_mes['Tempo Repouso Noturno'].dt.components.days * 24
                total_mes['Tempo Repouso Especial Diurno  = '] = total_mes['Tempo Repouso Especial Diurno'].dt.components.hours + total_mes['Tempo Repouso Especial Diurno'].dt.components.days * 24
                total_mes['Tempo Repouso Especial Noturno = '] = total_mes['Tempo Repouso Especial Noturno'].dt.components.hours + total_mes['Tempo Repouso Especial Noturno'].dt.components.days * 24
                
                ###

                total_mes['Repouso                        = '] = total_mes['Repouso                        = '].astype(str).str.zfill(2) + ':' + total_mes['Repouso'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Diurno           = '] = total_mes['Tempo Repouso Diurno           = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Noturno          = '] = total_mes['Tempo Repouso Noturno          = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Especial Diurno  = '] = total_mes['Tempo Repouso Especial Diurno  = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Especial Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Especial Noturno = '] = total_mes['Tempo Repouso Especial Noturno = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Especial Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                ...
                if periodo_mensal in total_mes.index:
                    # Acessar os valores específicos das colunas desejadas
                    valores = total_mes.loc[periodo_mensal, ['Repouso                        = ', 'Tempo Repouso Diurno           = ', 'Tempo Repouso Noturno          = ', 'Tempo Repouso Especial Diurno  = ', 'Tempo Repouso Especial Noturno = ']]
