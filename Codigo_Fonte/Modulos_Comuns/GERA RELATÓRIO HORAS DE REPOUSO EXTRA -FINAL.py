...
#            a partir de um arquivo CSV com as colunas Checkin, Repouso_extra, TJS, TJSD, TJSN, TJSE e TJSEN
...
# Filtrar o DataFrame para excluir as linhas onde a coluna 'Repouso Extra' é nula, vazia ou igual a '-'
dados = dados[(dados['Repouso Extra'].notnull()) & (dados['Repouso Extra'] != '') & (dados['Repouso Extra'] != '-')]

# CONVERTER AS COLUNAS Repouso, TJS, TJSD, TJSN, TJSE e TJSEN PARA timedelta
dados['Repouso Extra'] = pd.to_timedelta(dados['Repouso Extra'])
dados['Tempo Repouso Extra Diurno'] = pd.to_timedelta(dados['Tempo Repouso Extra Diurno'])
dados['Tempo Repouso Extra Noturno'] = pd.to_timedelta(dados['Tempo Repouso Extra Noturno'])
dados['Tempo Repouso Extra Especial Diurno'] = pd.to_timedelta(dados['Tempo Repouso Extra Especial Diurno'])
dados['Tempo Repouso Extra Especial Noturno'] = pd.to_timedelta(dados['Tempo Repouso Extra Especial Noturno'])
...
# Função para limpar e corrigir valores da coluna 'Repouso Extra'
...
def totalizar_por_semana(dados):
    ...
    colunas_tempo = ['Repouso Extra', 'Tempo Repouso Extra Diurno', 'Tempo Repouso Extra Noturno', 'Tempo Repouso Extra Especial Diurno', 'Tempo Repouso Extra Especial Noturno']
...
novo_nome = nome_arquivo.split(")")[0] + ") - REL_HORAS_DE_REPOUSO_EXTRA.txt"

with open(novo_nome, 'w') as arquivo:

    # centralizar o título
    titulo = 'RELATORIO TOTAL DE HORAS DE REPOUSO EXTRA' 
    largura_total = 120
    titulo_centralizado = titulo.center(largura_total)
    arquivo.write(titulo_centralizado + '\n')
    
    # alinhar a linha abaixo como cabeçalho
    arquivo.write('Activity'.ljust(15) + 'Checkin'.ljust(21) + 'Start'.ljust(14) + 'Dep'.ljust(5) + 'Arr'.ljust(12) + 'End'.ljust(20) + 'Checkout'.ljust(15) + 'Repouso Extra'.ljust(15) + '\n')
    ...
    for linha in range(len(dados)):
        ...
        # Converter 'Repouso Extra' para o formato HH:MM
        repouso_extra_timedelta = dados['Repouso Extra'][linha]
        horas, resto = divmod(repouso_extra_timedelta.total_seconds(), 3600)
        minutos, _ = divmod(resto, 60)
        repouso_extra_formatada = f"{int(horas):02}:{int(minutos):02}"
        ...
        arquivo.write(dados['Activity'][linha].ljust(8) + 
                      ...
                      repouso_extra_formatada.ljust(15) + '\n')
        ...
        if linha < len(dados) - 1:
            ...
            if pd.to_datetime(dados['Checkin'][linha]).week != pd.to_datetime(dados['Checkin'][linha + 1]).week:
                ...
                total_semana['Repouso                        = '] = total_semana['Repouso Extra'].dt.components.hours + total_semana['Repouso Extra'].dt.components.days * 24
                total_semana['Tempo Repouso Extra Diurno           = '] = total_semana['Tempo Repouso Extra Diurno'].dt.components.hours + total_semana['Tempo Repouso Extra Diurno'].dt.components.days * 24
                total_semana['Tempo Repouso Extra Noturno          = '] = total_semana['Tempo Repouso Extra Noturno'].dt.components.hours + total_semana['Tempo Repouso Extra Noturno'].dt.components.days * 24
                total_semana['Tempo Repouso Extra Especial Diurno  = '] = total_semana['Tempo Repouso Extra Especial Diurno'].dt.components.hours + total_semana['Tempo Repouso Extra Especial Diurno'].dt.components.days * 24
                total_semana['Tempo Repouso Extra Especial Noturno = '] = total_semana['Tempo Repouso Extra Especial Noturno'].dt.components.hours + total_semana['Tempo Repouso Extra Especial Noturno'].dt.components.days * 24
                
                ###

                total_semana['Repouso                        = '] = total_semana['Repouso                        = '].astype(str).str.zfill(2) + ':' + total_semana['Repouso Extra'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Extra Diurno           = '] = total_semana['Tempo Repouso Extra Diurno           = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Extra Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Extra Noturno          = '] = total_semana['Tempo Repouso Extra Noturno          = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Extra Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Extra Especial Diurno  = '] = total_semana['Tempo Repouso Extra Especial Diurno  = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Extra Especial Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_semana['Tempo Repouso Extra Especial Noturno = '] = total_semana['Tempo Repouso Extra Especial Noturno = '].astype(str).str.zfill(2) + ':' + total_semana['Tempo Repouso Extra Especial Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                ...
                if periodo_semanal in total_semana.index:
                    ...
                    valores = total_semana.loc[periodo_semanal, ['Repouso                        = ', 'Tempo Repouso Extra Diurno           = ', 'Tempo Repouso Extra Noturno          = ', 'Tempo Repouso Extra Especial Diurno  = ', 'Tempo Repouso Extra Especial Noturno = ']]
                ...
                arquivo.write(titulo_centralizado + '\n')
                # alinhar a linha abaixo como cabeçalho
                arquivo.write('Activity'.ljust(15) + 'Checkin'.ljust(21) + 'Start'.ljust(14) + 'Dep'.ljust(5) + 'Arr'.ljust(12) + 'End'.ljust(20) + 'Checkout'.ljust(15) + 'Repouso Extra'.ljust(21) + '\n')
            ...
            if semana_atual in total_semana.index: # coloquei agora
                ...
                valores = total_semana.loc[semana_atual, ['Repouso Extra', 'Tempo Repouso Extra Diurno', 'Tempo Repouso Extra Noturno', 'Tempo Repouso Extra Especial Diurno', 'Tempo Repouso Extra Especial Noturno']]
    ...
    for linha in range(len(dados)):
        ...
        if linha < len(dados) - 1:
            if pd.to_datetime(dados['Checkin'][linha]).month != pd.to_datetime(dados['Checkin'][linha + 1]).month:
                ...
                total_mes['Repouso                        = '] = total_mes['Repouso Extra'].dt.components.hours + total_mes['Repouso Extra'].dt.components.days * 24
                total_mes['Tempo Repouso Extra Diurno           = '] = total_mes['Tempo Repouso Extra Diurno'].dt.components.hours + total_mes['Tempo Repouso Extra Diurno'].dt.components.days * 24
                total_mes['Tempo Repouso Extra Noturno          = '] = total_mes['Tempo Repouso Extra Noturno'].dt.components.hours + total_mes['Tempo Repouso Extra Noturno'].dt.components.days * 24
                total_mes['Tempo Repouso Extra Especial Diurno  = '] = total_mes['Tempo Repouso Extra Especial Diurno'].dt.components.hours + total_mes['Tempo Repouso Extra Especial Diurno'].dt.components.days * 24
                total_mes['Tempo Repouso Extra Especial Noturno = '] = total_mes['Tempo Repouso Extra Especial Noturno'].dt.components.hours + total_mes['Tempo Repouso Extra Especial Noturno'].dt.components.days * 24
                
                ###

                total_mes['Repouso                        = '] = total_mes['Repouso                        = '].astype(str).str.zfill(2) + ':' + total_mes['Repouso Extra'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Extra Diurno           = '] = total_mes['Tempo Repouso Extra Diurno           = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Extra Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Extra Noturno          = '] = total_mes['Tempo Repouso Extra Noturno          = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Extra Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Extra Especial Diurno  = '] = total_mes['Tempo Repouso Extra Especial Diurno  = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Extra Especial Diurno'].dt.components.minutes.astype(str).str.zfill(2)
                total_mes['Tempo Repouso Extra Especial Noturno = '] = total_mes['Tempo Repouso Extra Especial Noturno = '].astype(str).str.zfill(2) + ':' + total_mes['Tempo Repouso Extra Especial Noturno'].dt.components.minutes.astype(str).str.zfill(2)
                ...
                if periodo_mensal in total_mes.index:
                    # Acessar os valores específicos das colunas desejadas
                    valores = total_mes.loc[periodo_mensal, ['Repouso                        = ', 'Tempo Repouso Extra Diurno           = ', 'Tempo Repouso Extra Noturno          = ', 'Tempo Repouso Extra Especial Diurno  = ', 'Tempo Repouso Extra Especial Noturno = ']]
                ...
                # iniciar novo for loop para imprimir os totais por mês
                # centralizar o título
                titulo = 'RELATORIO TOTAL DE HORAS DE REPOUSO'
                largura_total = 120
                titulo_centralizado = titulo.center(largura_total)
                arquivo.write(titulo_centralizado + '\n')
                # alinhar a linha abaixo como cabeçalho
